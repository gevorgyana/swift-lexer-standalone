...
int main() {
  ...
  clang::tok::TokenKind Kind = llvm::StringSwitch<clang::tok::TokenKind>(StringRef("23"))
#define TOKEN(id)			\
    .Case(#id, clang::tok::TokenKind::id)
#include "swift/Syntax/TokenKinds.def"
    .Default(clang::tok::TokenKind::pound);
  // std::cout << static_cast<SwiftToken>(Kind) << std::endl;
}
